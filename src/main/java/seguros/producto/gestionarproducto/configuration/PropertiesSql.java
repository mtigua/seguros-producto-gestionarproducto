...
public class PropertiesSql {
	...
	private String LISTAR_CRITERIOS_POR_PRODUCTO_PROFESION;
	private String SAVE_OR_UPDATE_NEMOTECNICO;
	private String LISTAR_PRODUCTOS_POR_COMPANIA_NEGOCIO_RAMO;
