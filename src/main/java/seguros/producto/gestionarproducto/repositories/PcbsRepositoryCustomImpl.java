...
public class PcbsRepositoryCustomImpl implements PCBSRepositoryCustom {
    ...
    public List<MonedaDto> findAllMoneda() throws PcbsException {
        ...
        String procedureNamefindAllMoneda = propertiesSql.getLISTAR_MONEDAS();
        List<MonedaDto> list = new ArrayList<>();
        List<Object[]> recordfindAllMoneda = null;

        try {
            StoredProcedureQuery storedProcedureQuery = entityManager.createStoredProcedureQuery(procedureNamefindAllMoneda);
            storedProcedureQuery.execute();
            recordfindAllMoneda = storedProcedureQuery.getResultList();

            if (recordfindAllMoneda != null) {
                recordfindAllMoneda.stream().forEach(p -> {
    ...
    public List<CompaniaDto> findAllCompania() throws PcbsException {
        String procedureNameCompaniafindAllCompania = propertiesSql.getLISTAR_COMPANIAS();
        List<CompaniaDto> listCompania = new ArrayList<>();
        List<Object[]> recordCompania = null;

        try {
            StoredProcedureQuery storedProcedureQuery = entityManager.createStoredProcedureQuery(procedureNameCompaniafindAllCompania);
            storedProcedureQuery.execute();
    ...
    public List<NegocioDto> findAllNegocioByCompania(Long idCompania) throws PcbsException {
        String negocioByCompania = propertiesSql.getLISTAR_NEGOCIOS_POR_COMPANIA();
        List<NegocioDto> listNegocio = new ArrayList<>();
        List<Object[]> recordNegocioByCompania = null;

        try {
            StoredProcedureQuery storedProcedureQuery = entityManager.createStoredProcedureQuery(negocioByCompania);
            ...
            storedProcedureQuery.execute();
            recordNegocioByCompania = storedProcedureQuery.getResultList();

            if (recordNegocioByCompania != null) {
                recordNegocioByCompania.stream().forEach(p -> {
    ...
    public Integer findNumPoliza(String numPoliza, String digito, Long idCompania, Long idNegocio, Long idRamo) throws PcbsException {
        ...
        try {
            ...
            Object objectfindNumPoliza = storedProcedureQuery.getOutputParameterValue(EXISTE);
            if (objectfindNumPoliza != null) {
                existe = (int) storedProcedureQuery.getOutputParameterValue(EXISTE);
            } else {
                PcbsException excecutefindNumPoliza = new PcbsException();
                excecutefindNumPoliza.setErrorMessage(VALUE_UNDEFINED + EXISTE);
                excecutefindNumPoliza.setDetail(VALUE_UNDEFINED + EXISTE);
                excecutefindNumPoliza.setConcreteException(excecutefindNumPoliza);
                throw excecutefindNumPoliza;
            }
    ...
    public Integer findCodigoPos(String numCodigoPos) throws PcbsException {
        ...
        Integer existefindCodigoPos = null;

        try {
            StoredProcedureQuery storedProcedureQueryfindCodigoPos = entityManager.createStoredProcedureQuery(procedureBuscaPoliza);
            storedProcedureQueryfindCodigoPos.registerStoredProcedureParameter("codigoPos", String.class, ParameterMode.IN);
            storedProcedureQueryfindCodigoPos.registerStoredProcedureParameter(EXISTE, Integer.class, ParameterMode.OUT);
            storedProcedureQueryfindCodigoPos.setParameter("codigoPos", numCodigoPos);
            storedProcedureQueryfindCodigoPos.execute();

            Object objectfindCodigoPos = storedProcedureQueryfindCodigoPos.getOutputParameterValue(EXISTE);

            if (objectfindCodigoPos != null) {
                existefindCodigoPos = (int) storedProcedureQueryfindCodigoPos.getOutputParameterValue(EXISTE);
            } else {
                PcbsException excecutefindCodigoPos = new PcbsException();
                excecutefindCodigoPos.setErrorMessage(VALUE_UNDEFINED + EXISTE);
                excecutefindCodigoPos.setDetail(VALUE_UNDEFINED + EXISTE);
                excecutefindCodigoPos.setConcreteException(excecutefindCodigoPos);
                throw excecutefindCodigoPos;
            }
    ...
    public List<AsociadoDto> getAsociado() throws PcbsException {
        ...
        List<Object[]> recordAsociado = null;
        try {
            StoredProcedureQuery storedProcedureQueryAsociado = entityManager.createStoredProcedureQuery(listarAsociado);
            storedProcedureQueryAsociado.execute();
            recordAsociado = storedProcedureQueryAsociado.getResultList();

            if (recordAsociado != null) {
                recordAsociado.stream().forEach(p -> {
    ...
    public List<AsociadoDto> getAsociadoEmision() throws PcbsException {
        String obtenerListaAsociadoEmision = propertiesSql.getLISTAR_ASOCIADO_EMISION();
        List<Object[]> recordAsociadoEmision = null;
        List<AsociadoDto> asociadoEmision = new ArrayList<>();
        try {
            StoredProcedureQuery storedProcedureQueryAsociadoEmision = entityManager.createStoredProcedureQuery(obtenerListaAsociadoEmision);
            storedProcedureQueryAsociadoEmision.execute();
            recordAsociadoEmision = storedProcedureQueryAsociadoEmision.getResultList();

            if (recordAsociadoEmision != null) {
                recordAsociadoEmision.stream().forEach(p -> {
                    AsociadoDto asociadoDto = new AsociadoDto();
                    asociadoDto.setCode(p[0].toString());
                    asociadoDto.setDescription(p[1].toString());
                    asociadoEmision.add(asociadoDto);
                });
            }
        } catch (Exception e) {
            throw new PcbsException(e);
        }
        return asociadoEmision;
    }
    ...
    public List<CatalogoCantidadCuotasDto> getCatalogoCuotas() throws PcbsException {
        List<CatalogoCantidadCuotasDto> catalogoCatalogoCuotasDtos = new ArrayList<>();
        try {
            ...
            TypedQuery<CatalogoCantidadCuotasDto> typedQueryCatalogoCuotas = entityManager.createQuery(
                    sqlQuery, CatalogoCantidadCuotasDto.class);
            catalogoCatalogoCuotasDtos = typedQueryCatalogoCuotas.getResultList();
        } catch (Exception e) {
            throw new PcbsException(e);
        }
        return catalogoCatalogoCuotasDtos;
    }
    ...
    public List<CatalogoCantidadCuotasDto> getCatalogoCuotasPayWeb() throws PcbsException {
        List<CatalogoCantidadCuotasDto> catalogoCatalogoCuotasPayWeb = new ArrayList<>();
        try {
            ...
            TypedQuery<CatalogoCantidadCuotasDto> typedQueryCatalogoCatalogoCuotasPayWeb = entityManager.createQuery(
                    sqlQuery, CatalogoCantidadCuotasDto.class);
            catalogoCatalogoCuotasPayWeb = typedQueryCatalogoCatalogoCuotasPayWeb.getResultList();
        } catch (Exception e) {
            throw new PcbsException(e);
        }
        return catalogoCatalogoCuotasPayWeb;
    }
    ...
    public Integer decryptPasswordProductManager(String rut, String password) throws PcbsException {
        ...
        try {
            StoredProcedureQuery storedPasswordProductManager = entityManager.createStoredProcedureQuery(procedureBuscaPoliza);
            storedPasswordProductManager.registerStoredProcedureParameter("password", String.class, ParameterMode.IN);
            storedPasswordProductManager.registerStoredProcedureParameter("rut", String.class, ParameterMode.IN);
            storedPasswordProductManager.registerStoredProcedureParameter(VALID, Integer.class, ParameterMode.OUT);
            storedPasswordProductManager.setParameter("rut", rut);
            storedPasswordProductManager.setParameter("password", password);
            storedPasswordProductManager.execute();

            Object resultProductManager = storedPasswordProductManager.getOutputParameterValue(VALID);
            if (resultProductManager != null) {
                existe = (int) storedPasswordProductManager.getOutputParameterValue(VALID);
            } else {
                PcbsException exc = new PcbsException();
    ...
    public String generateNemotecnico() throws PcbsException {
        ...
        try {
            ...
            if (result != null) {
                ...
                PcbsException executeGenerateNemotecnico = new PcbsException();
