...
@RestController
@Api(value="Tipo de multa Resource")
@RefreshScope
...
public class TipoMultaController {
	...
	private static final String SWAGGER_GET_TipoMulta = "Listar tipo de multa";
	...
	@ApiOperation(value = SWAGGER_GET_TipoMulta, notes = SWAGGER_GET_TipoMulta)
	@ApiResponses({ 
	...
	@GetMapping("/")
	public ResponseEntity<List<TipoMultaDto>> getTipoMulta(	) throws TipoMultaException{	
		List<TipoMultaDto> lista= null;
		try {	
			  lista= tipoMultaService.findAll();
			   
		}
		catch(TipoMultaException e) {
