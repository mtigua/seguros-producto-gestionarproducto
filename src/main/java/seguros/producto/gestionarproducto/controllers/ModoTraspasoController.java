...
public class ModoTraspasoController {
	...
	private static final Logger logger = LoggerFactory.getLogger(ModoTraspasoController.class.getSimpleName());
	...
	@GetMapping("/")
	public ResponseEntity<List<ModoTraspasoDto>> getModoTraspaso(
//			@RequestHeader(value = HEADER_AUTHORIZACION_KEY, required = true) 			
//			String token
			) throws ModoTraspasoException, UnauthorizedException{	
